...
const SWIFT_COMPLEXITY_VERSION_MISMATCH_PROBE: ShippedBrokenRun = ShippedBrokenRun {
    run: ShippedRun {
        project_types: SWIFT_PROJECT_TYPES,
        rule: SWIFT_COMPLEXITY_RULE,
...
const SWIFT_COMPLEXITY_HOLLOW_PROBE: ShippedHollowDirectory = ShippedHollowDirectory {
    ...
    directory: SWIFT_COMPLEXITY_HOLLOW_PATH,
    staged: SWIFT_COMPLEXITY_HOLLOW_FILES,
