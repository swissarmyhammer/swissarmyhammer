...
pub use model::{
    parse_model_config, parse_model_description, ChatModelConfig, EmbeddingModelConfig,
    ExecutorEntry, ModelConfig, ModelConfigSource, ModelError, ModelExecutorConfig,
    ModelExecutorType, ModelInfo, ModelManager, ModelPaths, ModelSource, Platform,
