...
complete -c kanban -n "__fish_kanban_needs_command" -f -a "completion" -d 'Generate shell completion scripts'
...
complete -c kanban -n "__fish_kanban_using_subcommand completion" -s d -l debug -d 'Enable debug output to stderr'
complete -c kanban -n "__fish_kanban_using_subcommand completion" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "serve" -d 'Run MCP server over stdio, exposing kanban tools'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "init" -d 'Install kanban MCP server into Claude Code settings'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "deinit" -d 'Remove kanban from Claude Code settings'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "doctor" -d 'Diagnose kanban configuration and setup'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c kanban -n "__fish_kanban_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
