...
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "serve" -d 'Run as MCP server (default when invoked via stdio)'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "doctor" -d 'Diagnose configuration and setup issues'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "prompt" -d 'Manage and test prompts'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "flow" -d 'Execute and manage workflows'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "validate" -d 'Validate prompt files and workflows for syntax and best practices'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "model" -d 'Manage and interact with models'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "agent" -d 'Manage and interact with Agent Client Protocol server'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve doctor prompt flow completion validate model agent help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
