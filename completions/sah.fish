...
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "serve" -d 'Run as MCP server (default when invoked via stdio)'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "init" -d 'Set up sah for all detected AI coding agents (skills + MCP)'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "deinit" -d 'Remove sah from all detected AI coding agents (skills + MCP)'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "doctor" -d 'Diagnose configuration and setup issues'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "validate" -d 'Validate prompt files for syntax and best practices'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "model" -d 'Manage and interact with models'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "agent" -d 'Manage and interact with Agent Client Protocol server'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "tools" -d 'Manage tool enable/disable state'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "statusline" -d 'Render statusline from Claude Code JSON (stdin) or dump config'
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
