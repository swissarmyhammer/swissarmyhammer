...
complete -c sah -n "__fish_sah_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor completion validate model agent tools statusline help" -f -a "validate" -d 'Validate skills and workflows for syntax and best practices'
