_avp() {
    ...
    do
        case "${cmd},${i}" in
            ...
            avp,new)
                ...
                ;;
            avp__subcmd__help,completion)
                cmd="avp__subcmd__help__subcmd__completion"
                ;;
    ...
    case "${cmd}" in
        ...
        avp__subcmd__help)
            ...
            return 0
            ;;
        avp__subcmd__help__subcmd__completion)
            opts=""
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _avp -o nosort -o bashdefault -o default avp
else
    complete -F _avp -o bashdefault -o default avp
fi
