_kanban() {
    ...
    do
        case "${cmd},${i}" in
            ",$1")
                ...
                ;;
            kanban,completion)
                cmd="kanban__subcmd__completion"
                ;;
            kanban,deinit)
            ...
            kanban,serve)
                ...
                ;;
            kanban__subcmd__help,completion)
                cmd="kanban__subcmd__help__subcmd__completion"
                ;;
    ...
    case "${cmd}" in
        ...
        kanban__subcmd__help)
            ...
            return 0
            ;;
        kanban__subcmd__help__subcmd__completion)
            opts=""
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _kanban -o nosort -o bashdefault -o default kanban
else
    complete -F _kanban -o bashdefault -o default kanban
fi
