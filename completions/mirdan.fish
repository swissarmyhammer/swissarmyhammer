...
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "agents" -d 'Detect and list installed AI coding agents'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "new" -d 'Create a new package from template'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "install" -d 'Install a package (type auto-detected from contents)'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "uninstall" -d 'Remove an installed package'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "list" -d 'List installed packages'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "search" -d 'Search the registry for skills and validators'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "info" -d 'Show detailed information about a package'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "login" -d 'Authenticate with the registry'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "logout" -d 'Log out from the registry and revoke token'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "whoami" -d 'Show current authenticated user'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "publish" -d 'Publish a package to the registry (type auto-detected)'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "unpublish" -d 'Remove a published package version from the registry'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "outdated" -d 'Check for available package updates'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "update" -d 'Update installed packages to latest versions'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "sync" -d 'Reconcile .skills/ with agent directories and verify lockfile'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "doctor" -d 'Diagnose Mirdan setup and configuration'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "start" -d 'Start the Mirdan tray/accessory app'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor start help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
