...
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update doctor help" -f -a "new" -d 'Create a new package from template'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update doctor help" -f -a "install" -d 'Install a package (type auto-detected from contents)'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update doctor help" -f -a "uninstall" -d 'Remove an installed package'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update doctor help" -f -a "list" -d 'List installed packages'
...
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update doctor help" -f -a "publish" -d 'Publish a package to the registry (type auto-detected)'
