...
complete -c mirdan -n "__fish_mirdan_needs_command" -f -a "install" -d 'Install a skill, validator, or MCP server (type auto-detected from contents)'
...
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor help" -f -a "new" -d 'Create a new skill or validator from template'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor help" -f -a "install" -d 'Install a skill, validator, or MCP server (type auto-detected from contents)'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor help" -f -a "uninstall" -d 'Remove an installed skill or validator package'
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor help" -f -a "list" -d 'List installed skills and validators'
...
complete -c mirdan -n "__fish_mirdan_using_subcommand help; and not __fish_seen_subcommand_from agents new install uninstall list search info login logout whoami publish unpublish outdated update sync doctor help" -f -a "publish" -d 'Publish a skill or validator to the registry (type auto-detected)'
