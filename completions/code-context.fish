...
function __fish_code_context_global_optspecs
	string join \n d/debug j/json no-progress h/help V/version
end
...
complete -c code-context -n "__fish_code_context_needs_command" -l no-progress -d 'Disable interactive progress bars for long-running operations'
...
complete -c code-context -n "__fish_code_context_needs_command" -f -a "rebuild" -d 'Trigger re-indexing'
...
complete -c code-context -n "__fish_code_context_needs_command" -f -a "completion" -d 'Generate shell completion scripts'
...
complete -c code-context -n "__fish_code_context_using_subcommand serve" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand serve" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand init" -l no-progress -d 'Disable interactive progress bars for long-running operations'
...
complete -c code-context -n "__fish_code_context_using_subcommand deinit" -l no-progress -d 'Disable interactive progress bars for long-running operations'
...
complete -c code-context -n "__fish_code_context_using_subcommand doctor" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand doctor" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand skill" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand skill" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and not __fish_seen_subcommand_from symbol callgraph blastradius status definition type-definition hover references implementations code-actions inbound-calls rename-edits diagnostics help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and not __fish_seen_subcommand_from symbol callgraph blastradius status definition type-definition hover references implementations code-actions inbound-calls rename-edits diagnostics help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from symbol" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from symbol" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from callgraph" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from callgraph" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from blastradius" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from blastradius" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from status" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from definition" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from definition" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from type-definition" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from type-definition" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from hover" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from hover" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from references" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from references" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from implementations" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from implementations" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from code-actions" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from code-actions" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from inbound-calls" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from inbound-calls" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from rename-edits" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from rename-edits" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from diagnostics" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand get; and __fish_seen_subcommand_from diagnostics" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand search; and not __fish_seen_subcommand_from symbol code workspace-symbol help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand search; and not __fish_seen_subcommand_from symbol code workspace-symbol help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from symbol" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from symbol" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from code" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from code" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from workspace-symbol" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand search; and __fish_seen_subcommand_from workspace-symbol" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand list; and not __fish_seen_subcommand_from symbols help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand list; and not __fish_seen_subcommand_from symbols help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand list; and __fish_seen_subcommand_from symbols" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand list; and __fish_seen_subcommand_from symbols" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand grep; and not __fish_seen_subcommand_from code help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand grep; and not __fish_seen_subcommand_from code help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand grep; and __fish_seen_subcommand_from code" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand grep; and __fish_seen_subcommand_from code" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand query; and not __fish_seen_subcommand_from ast help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand query; and not __fish_seen_subcommand_from ast help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand query; and __fish_seen_subcommand_from ast" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand query; and __fish_seen_subcommand_from ast" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand find; and not __fish_seen_subcommand_from duplicates help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand find; and not __fish_seen_subcommand_from duplicates help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand find; and __fish_seen_subcommand_from duplicates" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand find; and __fish_seen_subcommand_from duplicates" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -s d -l debug -d 'Enable debug output to stderr'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -s j -l json -d 'Output results as JSON (for operation commands)'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -f -a "index" -d 'Mark files for re-indexing by resetting indexed flags'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and not __fish_seen_subcommand_from index help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from index" -l layer -d 'Which indexing layer to reset: treesitter, lsp, or both' -r
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from index" -s d -l debug -d 'Enable debug output to stderr'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from index" -s j -l json -d 'Output results as JSON (for operation commands)'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from index" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from index" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from help" -f -a "index" -d 'Mark files for re-indexing by resetting indexed flags'
complete -c code-context -n "__fish_code_context_using_subcommand rebuild; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c code-context -n "__fish_code_context_using_subcommand clear; and not __fish_seen_subcommand_from status help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand clear; and not __fish_seen_subcommand_from status help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand clear; and __fish_seen_subcommand_from status" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand clear; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand lsp; and not __fish_seen_subcommand_from status help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand lsp; and not __fish_seen_subcommand_from status help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand lsp; and __fish_seen_subcommand_from status" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand lsp; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand detect; and not __fish_seen_subcommand_from projects help" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand detect; and not __fish_seen_subcommand_from projects help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand detect; and __fish_seen_subcommand_from projects" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand detect; and __fish_seen_subcommand_from projects" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c code-context -n "__fish_code_context_using_subcommand completion" -s d -l debug -d 'Enable debug output to stderr'
complete -c code-context -n "__fish_code_context_using_subcommand completion" -s j -l json -d 'Output results as JSON (for operation commands)'
complete -c code-context -n "__fish_code_context_using_subcommand completion" -l no-progress -d 'Disable interactive progress bars for long-running operations'
complete -c code-context -n "__fish_code_context_using_subcommand completion" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "serve" -d 'Run MCP server over stdio, exposing code-context tools'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "init" -d 'Install code-context MCP server into Claude Code settings'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "deinit" -d 'Remove code-context from Claude Code settings'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "doctor" -d 'Diagnose code-context configuration and setup'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "skill" -d 'Deploy code-context skill to agent .skills/ directories'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "get" -d 'Get a resource (symbol, callgraph, blast radius, status, etc.)'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "search" -d 'Search for symbols, code, or workspace symbols'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "list" -d 'List resources (symbols in a file)'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "grep" -d 'Regex search across stored code chunks'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "query" -d 'Execute tree-sitter queries against parsed ASTs'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "find" -d 'Find duplicated code'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "rebuild" -d 'Trigger re-indexing'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "clear" -d 'Wipe index data'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "lsp" -d 'LSP server management'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "detect" -d 'Detect project types and languages'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "completion" -d 'Generate shell completion scripts'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect completion help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c code-context -n "__fish_code_context_using_subcommand help; and __fish_seen_subcommand_from rebuild" -f -a "index" -d 'Mark files for re-indexing by resetting indexed flags'
