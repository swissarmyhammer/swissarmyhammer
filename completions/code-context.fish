...
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "serve" -d 'Run MCP server over stdio, exposing code-context tools'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "init" -d 'Install code-context MCP server into Claude Code settings'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "deinit" -d 'Remove code-context from Claude Code settings'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "doctor" -d 'Diagnose code-context configuration and setup'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "skill" -d 'Deploy code-context skill to agent .skills/ directories'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "get" -d 'Get a resource (symbol, callgraph, blast radius, status, etc.)'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "search" -d 'Search for symbols, code, or workspace symbols'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "list" -d 'List resources (symbols in a file)'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "grep" -d 'Regex search across stored code chunks'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "query" -d 'Execute tree-sitter queries against parsed ASTs'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "find" -d 'Find duplicated code'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "rebuild" -d 'Trigger re-indexing'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "clear" -d 'Wipe index data'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "lsp" -d 'LSP server management'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "detect" -d 'Detect project types and languages'
complete -c code-context -n "__fish_code_context_using_subcommand help; and not __fish_seen_subcommand_from serve init deinit doctor skill get search list grep query find rebuild clear lsp detect help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
