...
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "init" -d 'Install AVP hooks into Claude Code settings'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "deinit" -d 'Remove AVP hooks from Claude Code settings and delete .avp directory'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "doctor" -d 'Diagnose AVP configuration and setup'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "list" -d 'List all available validators'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "login" -d 'Authenticate with the AVP registry'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "logout" -d 'Log out from the AVP registry'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "whoami" -d 'Show current authenticated user'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "search" -d 'Search the AVP registry for packages'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "info" -d 'Show detailed information about a package'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "install" -d 'Install a package from the registry'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "uninstall" -d 'Remove an installed package'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "edit" -d 'Edit an existing RuleSet in $EDITOR'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "new" -d 'Create a new RuleSet from template'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "publish" -d 'Publish a package to the registry'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "unpublish" -d 'Remove a published package version from the registry'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "outdated" -d 'Check for available package updates'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "update" -d 'Update installed packages to latest versions'
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall edit new publish unpublish outdated update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
