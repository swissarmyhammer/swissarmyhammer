...
complete -c avp -n "__fish_avp_needs_command" -f -a "new" -d 'Create a new Validator from template'
...
complete -c avp -n "__fish_avp_using_subcommand help; and not __fish_seen_subcommand_from init deinit doctor list login logout whoami search info install uninstall new publish unpublish outdated update help" -f -a "new" -d 'Create a new Validator from template'
