...
function AttachmentDisplayAdapter({ value, mode, onCommit }: FieldDisplayProps) {
  return <AttachmentDisplay value={value} mode={mode} onCommit={onCommit} />;
}

function AttachmentListDisplayAdapter({ value, mode, onCommit }: FieldDisplayProps) {
  return <AttachmentListDisplay value={value} mode={mode} onCommit={onCommit} />;
}
