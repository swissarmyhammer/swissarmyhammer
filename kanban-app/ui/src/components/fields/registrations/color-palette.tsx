...
function ColorPaletteEditorAdapter({ value, onCommit, onCancel }: FieldEditorProps) {
  return <ColorPaletteEditor value={value} onCommit={onCommit} onCancel={onCancel} mode="compact" />;
}
