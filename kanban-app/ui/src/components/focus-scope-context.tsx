...
/**
 * Carries the moniker of the nearest ancestor entity-bound scope —
 ...
 */
export const FocusScopeContext = createContext<Moniker | null>(null);

/**
 * Read the moniker of the nearest ancestor `<FocusScope>` or `<FocusZone>`,
 * or `null` when no entity-bound scope wraps the caller.
 *
 * Uses React context so it skips intermediate `CommandScopeProvider`
 * pushes that aren't tied to an entity moniker.
 */
