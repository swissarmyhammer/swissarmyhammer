//! Build script for shelltool-cli.
//!
...
fn main() -> std::io::Result<()> {
    ...
    doc_gen::generate_markdown_with_brew(
        ...
        "shelltool",
        Some("swissarmyhammer/tap/shelltool-cli"),
    )?;

    doc_gen::generate_manpage(&cmd, &repo_root.join("docs"), "shelltool")?;

    doc_gen::generate_completions(cmd, &repo_root.join("completions"), "shelltool")?;
