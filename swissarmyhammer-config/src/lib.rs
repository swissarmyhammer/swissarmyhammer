...
///
/// Uses unsloth's Qwen3-0.6B (0.6B params) for fast CI runs and low memory usage.
pub const DEFAULT_TEST_LLM_MODEL_REPO: &str = "unsloth/Qwen3-0.6B-GGUF";
...
///
/// Qwen3-0.6B with IQ4_NL quantization for fast test execution.
pub const DEFAULT_TEST_LLM_MODEL_FILENAME: &str = "Qwen3-0.6B-IQ4_NL.gguf";
