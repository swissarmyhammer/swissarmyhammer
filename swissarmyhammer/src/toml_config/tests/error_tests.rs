...
mod config_error_tests {
    ...
    fn test_file_too_large_error() {
        ...
        assert!(error
            .to_string()
            .contains("Configuration file is too large"));
    ...
    fn test_nesting_too_deep_error() {
        ...
        assert!(error
            .to_string()
            .contains("Configuration nesting depth too deep"));
        assert!(error.to_string().contains("maximum:"));
    }
    ...
    fn test_error_display_and_debug() {
        ...
        let errors = vec![
            ...
            ConfigError::env_var_substitution(
                "TEST_VAR".to_string(),
...
mod edge_case_tests {
    ...
    fn test_numeric_edge_cases() {
        ...
        assert_eq!(config.get("zero").unwrap().coerce_to_integer().unwrap(), 0);
    }
    ...
    fn test_table_edge_cases() {
        ...
        assert_eq!(
            config
                .get("table_with_subtable.child.key")
                .unwrap()
                .coerce_to_string()
                .unwrap(),
            "child"
