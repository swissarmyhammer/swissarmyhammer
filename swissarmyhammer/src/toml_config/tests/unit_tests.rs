...
use crate::toml_config::{
    ConfigError, ConfigParser, ConfigValue, Configuration, ValidationLimits,
};
...
mod config_value_tests {
    ...
    fn test_config_value_integer_operations() {
        ...
        assert_eq!(value.coerce_to_boolean().unwrap(), true);
    ...
    fn test_config_value_float_operations() {
        ...
        // Test coercion
        assert_eq!(value.coerce_to_float().unwrap(), 3.14);
        assert_eq!(value.coerce_to_string().unwrap(), "3.14");
        ...
        // Test liquid conversion
        let liquid_value = value.to_liquid_value();
        assert_eq!(liquid_value, liquid::model::Value::scalar(3.14));
    }
    ...
    fn test_config_value_boolean_operations() {
        ...
        assert_eq!(value_true.coerce_to_boolean().unwrap(), true);
        ...
        assert_eq!(value_false.coerce_to_boolean().unwrap(), false);
    ...
    fn test_config_value_validation() {
        ...
        let large_array = vec![ConfigValue::Integer(1); ValidationLimits::default().max_array_length + 1];
    ...
    fn test_environment_variable_substitution() {
        ...
        value.substitute_env_vars().unwrap();
        assert_eq!(value, ConfigValue::String("prefix_test_value_suffix".to_string()));
        ...
        if let ConfigValue::Array(result_array) = value {
            assert_eq!(result_array[0], ConfigValue::String("test_value".to_string()));
        ...
        let mut table = HashMap::new();
        table.insert("key1".to_string(), ConfigValue::String("${TEST_VAR}".to_string()));
        table.insert("key2".to_string(), ConfigValue::String("${TEST_NUMBER}".to_string()));
        let mut value = ConfigValue::Table(table);
        value.substitute_env_vars().unwrap();
        if let ConfigValue::Table(result_table) = value {
            assert_eq!(result_table.get("key1"), Some(&ConfigValue::String("test_value".to_string())));
            assert_eq!(result_table.get("key2"), Some(&ConfigValue::String("123".to_string())));
        } else {
...
mod configuration_tests {
    ...
    fn test_configuration_basic_operations() {
        ...
        // Insert basic values
        config.insert("name".to_string(), ConfigValue::String("test_project".to_string()));
    ...
    fn test_configuration_dot_notation_get() {
        ...
        config.set("database.credentials.username".to_string(), ConfigValue::String("user".to_string()));
        config.set("database.credentials.password".to_string(), ConfigValue::String("pass".to_string()));
    ...
    fn test_configuration_dot_notation_set() {
        ...
        config.set("app.name".to_string(), ConfigValue::String("TestApp".to_string()));
        config.set("app.version".to_string(), ConfigValue::String("2.0.0".to_string()));
        ...
        config.set("app.database.primary.host".to_string(), ConfigValue::String("db1.example.com".to_string()));
        config.set("app.database.primary.port".to_string(), ConfigValue::Integer(5432));
        
        // Verify structure was created correctly
        assert_eq!(config.get("app.name"), Some(&ConfigValue::String("TestApp".to_string())));
        assert_eq!(config.get("app.version"), Some(&ConfigValue::String("2.0.0".to_string())));
        assert_eq!(config.get("app.features.auth"), Some(&ConfigValue::Boolean(true)));
        assert_eq!(config.get("app.features.api"), Some(&ConfigValue::Boolean(true)));
        assert_eq!(config.get("app.database.primary.host"), Some(&ConfigValue::String("db1.example.com".to_string())));
        assert_eq!(config.get("app.database.primary.port"), Some(&ConfigValue::Integer(5432)));
        
        // Test overwriting existing values
        config.set("app.name".to_string(), ConfigValue::String("UpdatedApp".to_string()));
        assert_eq!(config.get("app.name"), Some(&ConfigValue::String("UpdatedApp".to_string())));
        
        // Test replacing table with scalar value
        config.set("app.features".to_string(), ConfigValue::String("disabled".to_string()));
        assert_eq!(config.get("app.features"), Some(&ConfigValue::String("disabled".to_string())));
    ...
    fn test_configuration_remove() {
        ...
        // Set up test data
        config.set("simple".to_string(), ConfigValue::String("value".to_string()));
        config.set("nested.key1".to_string(), ConfigValue::String("value1".to_string()));
        config.set("nested.key2".to_string(), ConfigValue::String("value2".to_string()));
    ...
    fn test_configuration_merge() {
        ...
        config1.insert("key1".to_string(), ConfigValue::String("value1".to_string()));
        config1.insert("shared".to_string(), ConfigValue::String("original".to_string()));
        config1.insert("nested".to_string(), ConfigValue::Table({
            let mut table = HashMap::new();
        ...
        config2.insert("key2".to_string(), ConfigValue::String("value2".to_string()));
        config2.insert("shared".to_string(), ConfigValue::String("updated".to_string()));
        config2.insert("nested".to_string(), ConfigValue::Table({
            let mut table = HashMap::new();
        ...
        assert_eq!(merged.get("key1"), Some(&ConfigValue::String("value1".to_string())));
        assert_eq!(merged.get("key2"), Some(&ConfigValue::String("value2".to_string())));
        assert_eq!(merged.get("shared"), Some(&ConfigValue::String("original".to_string()))); // Should not overwrite
        ...
        assert_eq!(merged.get("key1"), Some(&ConfigValue::String("value1".to_string())));
        assert_eq!(merged.get("key2"), Some(&ConfigValue::String("value2".to_string())));
        assert_eq!(merged.get("shared"), Some(&ConfigValue::String("updated".to_string()))); // Should overwrite
    }
    ...
    fn test_configuration_liquid_conversion() {
        ...
        config.insert("name".to_string(), ConfigValue::String("TestProject".to_string()));
        config.insert("version".to_string(), ConfigValue::String("1.0.0".to_string()));
        config.insert("debug".to_string(), ConfigValue::Boolean(true));
        ...
        database_table.insert("host".to_string(), ConfigValue::String("localhost".to_string()));
    ...
    fn test_configuration_validation() {
        ...
        config.insert("valid_name".to_string(), ConfigValue::String("value".to_string()));
        config.insert("another_valid".to_string(), ConfigValue::Integer(42));
        assert!(config.validate().is_ok());
        
        // Test invalid variable name
        config.insert("123invalid".to_string(), ConfigValue::String("value".to_string()));
    ...
    fn test_configuration_environment_substitution() {
        ...
        let mut config = Configuration::new();
        config.insert("simple".to_string(), ConfigValue::String("${CONFIG_TEST_VAR}".to_string()));
        config.insert("with_default".to_string(), ConfigValue::String("${NONEXISTENT:-default}".to_string()));
        config.insert("number".to_string(), ConfigValue::String("${CONFIG_NUMBER}".to_string()));
        ...
        let mut table = HashMap::new();
        table.insert("nested_var".to_string(), ConfigValue::String("${CONFIG_TEST_VAR}".to_string()));
        ...
        if let Some(ConfigValue::Array(array)) = config.get("array_test") {
            assert_eq!(array[0], ConfigValue::String("substituted_value".to_string()));
...
mod parser_tests {
    ...
    fn test_parser_valid_toml() {
        ...
        assert_eq!(config.get("database.port"), Some(&ConfigValue::Integer(5432)));
        assert_eq!(
            config.get("database.credentials.username"),
            Some(&ConfigValue::String("user".to_string()))
        );
        ...
        assert_eq!(config.get("build.optimized"), Some(&ConfigValue::Boolean(true)));
    ...
    fn test_parser_file_operations() {
        ...
        assert_eq!(config.get("settings.debug"), Some(&ConfigValue::Boolean(false)));
        assert_eq!(config.get("settings.timeout"), Some(&ConfigValue::Integer(60)));
