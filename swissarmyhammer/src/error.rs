...
//!
//! Core infrastructure errors are now provided by swissarmyhammer-common,
//! while this module focuses on domain-specific errors for the main library.
...
pub enum SwissArmyHammerError {
    /// Common infrastructure error from swissarmyhammer-common
    #[error(transparent)]
    ...
    /// IO error - delegates to common crate
    #[error(transparent)]
    Io(#[from] std::io::Error),

    /// Not in Git repository - delegates to common crate  
...
// Backward compatibility re-exports for commonly used error types
// These allow existing code to continue working without changes

/// Re-export of IO error for backward compatibility
pub use std::io::Error as IoError;

/// Re-export of JSON error for backward compatibility  
