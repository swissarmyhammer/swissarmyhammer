...
fn parse_parameter_value(value: &str, param_type: &crate::workflow::ParameterType) -> crate::Result<Value> {
    match param_type {
...
mod tests {
    ...
    fn test_parameter_name_to_cli_switch() {
        ...
        assert_eq!(parameter_name_to_cli_switch("multi_word_param"), "--multi-word-param");
    }
