...
async fn test_swissarmyhammer_binary_exists() {
    ...
    assert!(result.stdout.contains("swissarmyhammer"), "Version output should contain swissarmyhammer");
}
...
async fn test_swissarmyhammer_has_expected_commands() {
    ...
    assert!(output.contains("serve"), "Help should mention serve command");
    assert!(output.contains("doctor"), "Help should mention doctor command");
    assert!(output.contains("prompt"), "Help should mention prompt command");
    assert!(output.contains("flow"), "Help should mention flow command");
    assert!(output.contains("completion"), "Help should mention completion command");
    assert!(output.contains("validate"), "Help should mention validate command");
}
