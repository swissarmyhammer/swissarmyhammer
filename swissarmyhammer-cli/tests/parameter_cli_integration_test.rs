...
use swissarmyhammer_cli::parameter_cli::{resolve_workflow_parameters, get_workflow_parameters_for_help};
...
fn test_parameter_resolution_with_valid_workflow() {
    ...
    let result = resolve_workflow_parameters("nonexistent-workflow", &["name=John".to_string()], &[]);
...
fn test_parameter_resolution_with_invalid_var_format() {
    ...
    let result = resolve_workflow_parameters("test-workflow", &["invalid_format".to_string()], &[]);
...
fn test_backward_compatibility() {
    ...
    let result = resolve_workflow_parameters(
...
fn test_empty_parameters() {
    let result = resolve_workflow_parameters("test-workflow", &[], &[]);
...
"#;
        ...
        let result = resolve_workflow_parameters("test", &["test_param=value".to_string()], &[]);
