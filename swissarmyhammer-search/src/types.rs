...
pub struct FileChangeReport {
    ...
    pub errors: std::collections::HashMap<PathBuf, crate::error::SearchError>,
}
...
impl FileChangeReport {
    ...
    pub fn add_error(&mut self, path: PathBuf, error: crate::error::SearchError) {
...
impl SemanticConfig {
    ...
    pub fn to_parser_config(&self) -> crate::error::SearchResult<crate::parser::ParserConfig> {
...
mod tests {
    ...
    fn test_file_change_report_add_error() {
        ...
        let error = crate::error::SearchError::Config("Test error".to_string());
    ...
    fn test_file_change_report_summary() {
        ...
        report.add_error(
            ...
            crate::error::SearchError::Config("Test error".to_string()),
        );
...
pub struct SearchStats {
    ...
    pub model_info: crate::embedding::EmbeddingModelInfo,
}
