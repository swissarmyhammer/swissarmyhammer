...
- ✅ Shared across projects (same file + rule = cached)
- ✅ Standard platform cache location
...
- ❌ Same file checked in different projects = separate cache entries
- ❌ Takes up space in git repo
