...
| `01KS36TCNMSDGSQBZP3NKY6YK7` | Builtin plugin: entity + clipboard (entity.yaml) | sdk-helpers, catalog, **entity-service** | `entity-commands` (8): CRUD + archive + clipboard → **`entity` server**; `from: target`. |
