...
use super::tool_registry::{
    register_abort_tools, register_cel_tools, register_file_tools, register_flow_tools,
    register_git_tools, register_questions_tools, register_rules_tools, register_shell_tools,
