...
**If the rule is not applicable to this file type, respond with exactly:**

PASS

**If the rule is followed, respond with exactly:**

PASS

**If violations are found, respond with the following format for EACH violation:**

** Important: If a rule passes, the repose you generate must start with PASS**
