...
{
  "status": "passed",
  "message": "All functions are within length limits"
}
```
...
{
  "status": "failed",
  "message": "Found 1 long function - Line 42: function 'process_all_data' is 75 lines (limit: 50). Suggest: extract logical sections into helper functions"
}
```
